...
const PercentageToGpa = () => {
    ...
    return (
        <View>
            <Header headerText={'Percentage to GPA'} />

            <View style={styles.inputContainer}>

                <Text style={styles.text}>Enter your percentage</Text>
                ...
                />
                {
                    message != ''
                        ...
                        :
                        <Text style={styles.message}>{`Your gpa is : ${spga}`}</Text>
                }
                ...
                <Text style={styles.note}>Note: Enter value between 0 - 100</Text>
            </View>
        </View>
    )
}
