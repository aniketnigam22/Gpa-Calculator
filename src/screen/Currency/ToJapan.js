...
const ToJapan = () => {
        ...
        try {
            ...
            await axios.get(`https://${host}/latest?amount=${fromCurrencyValue}&from=${fromCurrency}&to=${toCurrency}`)
                .then(response => {
                    ...
                    if (rates.JPY != null && rates.JPY !== '') {
                        console.log('value set for JPY', rates.JPY);
                        setResultAmount(rates.JPY);
    ...
    return (
        <View >
            <Header headerText={'INR to JAPAN'} />
            <Text>hello</Text>
                ...
                <SelectDropdown
                    ...
                    onSelect={(selectedItem, index) => {
                        ...
                        if (selectedItem.title === 'INR') {
                            setFromCurrency('INR');
                            setToCurrency('JPY');
                        } else if (selectedItem.title === 'JPY') {
                            setFromCurrency('JPY');
                            setToCurrency('INR');
                        }
